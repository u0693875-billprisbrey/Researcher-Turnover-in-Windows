...
# Needs sorting, and add the descr why not.  Color code somehow?

# Now I need to see which reasons apply to multiple actions
...
reasonsPerAction <- aggregate(ACTION_REASON ~ ACTION + ACTION_DESCR, journeyData, function(x){length(unique(x))} )  # That's a good one
# let's move that one up earlier
