...
Please see the report [[NAME]] for a lengthier description of the clusters. 
...
Percentiles are calculated based on the ten year sum of funds requested won per PI.  Please see the report [[NAME]] for a lengthier description.
