...
*7 July 2025:*  Team meets and reviews Kaidon's work.  Kaidon and Dave determine that eAwards shouldn't be used to identify changes in PI due to incompleteness and discrepancies with the OSP data warehouse.  Rather, a "system of record" used by Finance should be used, and Dave identifies the table "FSPROD.PS_PROJECT_TEAM" that appears to have the changes.  Kaidon is investigating and requesting access for Bill from the data stewards Steven Phillips, Terri O'Toole, and John Nilsson.